...
public class ArtifactsDeployer {
    ...
    public void deploy() throws IOException, InterruptedException {
        ...
        for (Map.Entry<MavenModule, MavenBuild> mavenBuildEntry : mavenBuildMap.entrySet()) {
            ...
            listener.getLogger().println("Deploying main artifact: " + artifactToString(mavenArtifact, mavenBuild));
            ...
            if (!mar.isPOM() && mar.pomArtifact != null && mar.pomArtifact != mar.mainArtifact) {
                ...
                listener.getLogger().println(
                        "Deploying pom artifact: " + artifactToString(mar.mainArtifact, mavenBuild));
            ...
            for (MavenArtifact attachedArtifact : mar.attachedArtifacts) {
                listener.getLogger().println(
                        "Deploying attached artifact: " + artifactToString(attachedArtifact, mavenBuild));
